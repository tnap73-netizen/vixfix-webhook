...
Runs Basket 1, 2, 3 sequentially in a single blpapi session.
Returns combined JSON to stdout.
"""
...
if all(v is not None for v in [ema_20, ema_50, ema_100, ema_200]):
    ...
    fan = "INSUFFICIENT DATA"

gp_realtime.update({
    "EMA_20D": ema_20, "EMA_50D": ema_50,
    "EMA_100D": ema_100, "EMA_200D": ema_200,
    "EMA_FAN": fan, "BARS_LOADED": len(closes)
})
if px and ema_50:  gp_realtime["VS_50EMA"]  = round((px/ema_50 - 1)*100, 2)
if px and ema_100: gp_realtime["VS_100EMA"] = round((px/ema_100 - 1)*100, 2)
if px and ema_200: gp_realtime["VS_200EMA"] = round((px/ema_200 - 1)*100, 2)
...
own = bdp([
    "PX_LAST", "SHORT_INT_RATIO", "RETURN_COM_EQY"
])
output["OWN"] = own
